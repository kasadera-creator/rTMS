...
def create_initial_data():
    ...
    dummy_data = {
        ...
        'mapping_date': date(2025, 12, 12),  # 初回位置決め日
        'first_treatment_date': date(2025, 12, 15), # 初回治療日
    ...
    if created:
        ...
        # 既存患者の場合もデータを更新する
        patient.mapping_date = dummy_data['mapping_date']
        patient.first_treatment_date = dummy_data['first_treatment_date']
        patient.save()
